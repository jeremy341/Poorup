...
const THEMES = [
  {
    ...
    shortName: "ORIGINAL",
    description: "The original dark Poorup parlor overlooking Midnight Ledger City.",
    ariaLabel: "Original Midnight Ledger City. Dark teal skyline, gold crescent, rooftop details, and slow fog.",
    preview: { heading: "ORIGINAL", copy: "Midnight ledger city" },
    scene: null,
    homeScene: scenePath("original"),
    props: {},
    homeProps: {
      fog: propPath("original", "fog"),
    },
    tokens: {},
    palette: {},
    skyline: { home: BASE_SKYLINE, board: BASE_SKYLINE },
    motion: { weather: "fog", durationMs: 48000 },
  },
  {
    id: "spring",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--gold-050": "#fff2bf", "--gold-100": "#f5df9c", "--gold-300": "#e5bd57", "--gold-400": "#d6a33f", "--gold-500": "#b8843a", "--gold-muted": "#c6b478",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--gold-050": "#f6d9a4", "--gold-100": "#e9bf82", "--gold-300": "#d28c47", "--gold-400": "#d28a4d", "--gold-500": "#bd7a48", "--gold-muted": "#b89b78",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--theme-focus": "#f5f6d6", "--theme-warning": "#d7c96d", "--theme-logo-primary": "#5c8290", "--theme-logo-secondary": "#d7c96d", "--theme-icon-primary": "#d7c96d", "--theme-icon-secondary": "#f5f6d6", "--theme-scrim": "#06161bd9", "--theme-scanline": "#eff6de0b", "--theme-action-edge": "#3ba267", "--theme-action-shadow": "#22663f", "--theme-action-shadow-muted": "#17472f", "--wordmark-color": "#1f4154", "--wordmark-shadow-1": "#5e919d", "--wordmark-shadow-2": "#3c6f7b", "--wordmark-shadow-3": "#183a43", "--surface-button-hover": "#154b45", "--surface-button-pressed": "#123b3d", "--surface-disabled": "#10383d", "--field-placeholder": "#b5cfca", "--theme-setup-scrim": "#06161bd9", "--theme-gallery-scrim": "#06161be8", "--surface-card-highlight": "#154b45", "--go-shadow-1": "#5e919d", "--go-shadow-2": "#3c6f7b", "--night-shadow": "#3c6f7b",
    },
  },
];
