...
export function resolveThemeTrack(themeId, manifest = MUSIC_MANIFEST) { const id = manifest.defaults[sanitizeThemeId(themeId, manifest)]; return sanitizeTrackId(id, manifest); }
