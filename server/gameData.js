...
const DEFAULT_TILES = [
  ...
  { index: 11, name: 'Pattaya', type: 'property', group: 'Pink', price: 140, rent: 14, color: '#a04e6f' },
  { index: 12, name: 'Electric Company', type: 'utility', price: 150, rent: 12 },
  { index: 13, name: 'Chiang Mai', type: 'property', group: 'Pink', price: 140, rent: 16, color: '#a04e6f' },
  { index: 14, name: 'Bangkok', type: 'property', group: 'Pink', price: 160, rent: 18, color: '#a04e6f' },
  { index: 15, name: 'BKK Airport', type: 'railroad', price: 200, rent: 25 },
  { index: 16, name: 'Kyoto', type: 'property', group: 'Orange', price: 180, rent: 16, color: '#b96d2a' },
  { index: 17, name: 'Treasure', type: 'chest' },
  { index: 18, name: 'Osaka', type: 'property', group: 'Orange', price: 180, rent: 16, color: '#b96d2a' },
  { index: 19, name: 'Tokyo', type: 'property', group: 'Orange', price: 200, rent: 18, color: '#b96d2a' },
  { index: 20, name: 'Vacation', type: 'vacation' },
  { index: 21, name: 'Eindhoven', type: 'property', group: 'Red', price: 220, rent: 20, color: '#87231e' },
  { index: 22, name: 'Surprise?', type: 'chance' },
  { index: 23, name: 'Rotterdam', type: 'property', group: 'Red', price: 220, rent: 20, color: '#87231e' },
  { index: 24, name: 'Amsterdam', type: 'property', group: 'Red', price: 240, rent: 22, color: '#87231e' },
