...
export const MARKET_ORDER_GUARDS = [
  ...
  { test: game => game.auction || game.pendingPurchaseOffer || game.pendingSponsoredPurchase || game.pendingTrade || game.pendingPlayerContract, error: 'Resolve the table obligation before trading.' },
