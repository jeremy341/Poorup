...
const DEFAULT_TILES = [
  ...
  { index: 2, name: 'Chance', type: 'chance' },
  { index: 3, name: 'Rio', type: 'property', group: 'Brown', price: 60, rent: 10, color: '#92400e' },
  { index: 4, name: 'Income Tax', type: 'tax', amount: 200 },
  { index: 5, name: 'ACC Airport', type: 'utility', price: 200, rent: 25, color: '#0f172a' },
  { index: 6, name: 'Accra', type: 'property', group: 'Light Blue', price: 100, rent: 14, color: '#38bdf8' },
  { index: 7, name: 'Tema', type: 'property', group: 'Light Blue', price: 100, rent: 14, color: '#38bdf8' },
  { index: 8, name: 'Kumasi', type: 'property', group: 'Light Blue', price: 120, rent: 16, color: '#38bdf8' },
  { index: 9, name: 'Jail', type: 'jail' },
  { index: 10, name: 'Tokyo', type: 'property', group: 'Orange', price: 140, rent: 18, color: '#f97316' },
  { index: 11, name: 'Surprise', type: 'chance' },
  { index: 12, name: 'Bangkok', type: 'property', group: 'Orange', price: 140, rent: 18, color: '#f97316' },
  { index: 13, name: 'Pataya', type: 'property', group: 'Orange', price: 160, rent: 20, color: '#f97316' },
  { index: 14, name: 'Luxury Tax', type: 'tax', amount: 100 },
  { index: 15, name: 'BKK Airport', type: 'utility', price: 200, rent: 25, color: '#0f172a' },
  { index: 16, name: 'Kyoto', type: 'property', group: 'Red', price: 180, rent: 22, color: '#dc2626' },
  { index: 17, name: 'OSAKA', type: 'property', group: 'Red', price: 180, rent: 22, color: '#dc2626' },
  { index: 18, name: 'Vacation', type: 'vacation' },
  { index: 19, name: 'Go to Jail', type: 'goToJail' },
  { index: 20, name: 'Toronto', type: 'property', group: 'Green', price: 220, rent: 26, color: '#15803d' },
  { index: 21, name: 'Water Company', type: 'utility', price: 150, rent: 20, color: '#0f172a' },
  { index: 22, name: 'Vancouver', type: 'property', group: 'Green', price: 220, rent: 26, color: '#15803d' },
  { index: 23, name: 'Calgary', type: 'property', group: 'Green', price: 240, rent: 28, color: '#15803d' }
];
