...
const suites = ['server/gameLogic.test.js', 'server/applyCard.test.js', 'server/rent.test.js', 'server/persistence.test.js', 'server/leaderboard.test.js', 'server/botLogic.test.js'];
let failed = 0;
