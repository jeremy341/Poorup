...
const suites = ['server/gameLogic.test.js', 'server/applyCard.test.js', 'server/rent.test.js', 'server/persistence.test.js', 'server/leaderboard.test.js', 'server/game-results.test.js', 'server/botLogic.test.js', 'server/global-events.test.js'];
let failed = 0;
